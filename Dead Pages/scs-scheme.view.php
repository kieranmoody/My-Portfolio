    ...
    <body>
        ...
        <section class="bg-dark text-white text-center py-5 position-relative">
                ...
                <div class="container position-relative">
                    <h1 class="display-4 text-white title-animate">The SCS Scheme</h1>
                    <p class="lead text-white mb-5">Training, learning and industry preparation</p>
                    <a href="#scs-scheme" class="btn btn-outline-secondary btn-hover">Scroll Down 
                        <br>
